...
const (
	...
	// alpha: v1.29
	//
	// Enables override pod host network by the pod annotation
	KubeletPodOverrideHostNetwork featuregate.Feature = "KubeletPodOverrideHostNetwork"
...
var defaultKubernetesFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	KubeletPodOverrideHostNetwork: {Default: false, PreRelease: featuregate.Alpha},
